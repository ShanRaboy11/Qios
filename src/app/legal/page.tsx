...
import { ShieldCheck, FileText, Cookie, AlertCircle, ArrowRight } from "lucide-react";
...
const legalDocs = [
  ...
  },
  {
    ...
    description: "The rules, guidelines, and agreements for using the Qios platform.",
  ...
  },
  {
    ...
    description: "Guidelines on acceptable content and behavior on our platform.",
...
export default function LegalCenter() {
  return (
    <div className="flex flex-col items-center w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24">
      {/* Hero Section */}
      <div className="max-w-4xl mx-auto text-center space-y-4 mb-16 md:mb-24">
        ...
        <p className="h4 text-text-secondary max-w-2xl mx-auto leading-relaxed max-md:text-base">
          We are committed to transparency, security, and protecting your data. Review our legal agreements and policies below.
        </p>
      </div>
      ...
      <div className="mt-24 text-center max-w-2xl">
        <h3 className="text-xl font-bold text-text-primary mb-2">Have questions?</h3>
        <p className="text-text-secondary">
          If you have any questions about our legal policies, privacy practices, or compliance, please reach out to our team at <a href="mailto:legal@qios.com" className="text-brand-accent hover:underline">legal@qios.com</a>.
        </p>
      </div>
    </div>
  );
