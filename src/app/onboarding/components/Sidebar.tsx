...
import { 
  Check, Pizza, Coffee, Utensils, ChefHat, 
  IceCream, Sandwich, Grape, UtensilsCrossed, Soup, Cake
} from "lucide-react";
...
export function OnboardingSidebar({ steps, currentStep }: SidebarProps) {
  ...
  return (
    <div className={cn(
      "w-full lg:w-[45%] xl:w-[55%] h-auto lg:h-screen sticky z-40 overflow-hidden",
      "top-[120px] lg:top-0", 
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden flex items-center justify-end pointer-events-none opacity-60">
            <div className="relative shrink-0 -mr-[200px] md:-mr-[400px]" style={{ transform: "scale(1.5)" }}>
                <div className="opacity-50 overflow-visible animate-[spin_300s_linear_infinite]" style={{ width: "1148.236px", height: "969.879px" }}>
                    <svg className={vectorStyle} style={{ width: "1042.004px", height: "788.681px" }} viewBox="0 0 758 823" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M359.571 446.233C342.914 434.14 334.103 419.712 340.619 398.512C362.742 326.978 436.795 267.944 421.702 189.12C413.898 148.649 379.943 112.831 331.565 85.1615C102.725 -45.3288 -112.713 6.65592 -177.691 43.3137C-244.286 80.8642 -208.584 155.774 -173.522 204.454C-130.355 264.445 -75.6605 324.382 -69.361 389.956C-62.7223 459.193 -29.6821 617.07 14.4358 685.987C45.5628 734.609 122.809 802.806 200.619 811.699C278.429 820.593 354.88 772.413 413.725 742.99C472.569 713.566 718.693 857.298 746.355 811.575C783.548 750.091 701.012 672.472 641.821 622.7C581.798 572.244 512.262 526.775 436.709 486.203C408.707 471.246 378.883 460.294 359.571 446.233Z" stroke="#FFC670" strokeOpacity="1" strokeWidth="3" />
                    </svg>
                </div>
            </div>
        </div>
      ...
      <div className="flex flex-row lg:flex-col gap-4 md:gap-12 lg:gap-12 relative justify-center items-center z-10">
        {steps.map((step, index) => {
          ...
          return (
            <div key={step.id} className="relative flex flex-col lg:flex-row items-center gap-2 lg:gap-10 lg:w-[320px]">
