...
const features = [
  {
    ...
    description:
      "Customers access the full digital menu on their own device — no download, no login, no friction. A unique QR captures their order ID and timestamp for staff to retrieve instantly.",
  },
  {
    icon: (
      <img src="/svg/Stock.svg" alt="Stock" className="w-[24px] h-[24px]" />
    ),
    title: "Stock That Watches Itself.",
    description:
      "Toggle between simple unit-count tracking or a measurement-based recipe matrix that auto-deducts ingredients.",
  },
  {
    icon: <img src="/svg/Hand.svg" alt="Hand" className="w-[24px] h-[24px]" />,
    title: "Built for How People Order.",
    description:
      "Customers browse, pick modifiers, select sizes, and watch their total update live — all from a website.",
  },
  {
    icon: (
    ...
    description:
      "Track order velocity, prep times, and staff productivity on one real-time dashboard.",
  },
  {
    icon: (
      <img src="/svg/Shield.svg" alt="Shield" className="w-[24px] h-[24px]" />
    ),
    title: "Validate. Process. Close.",
    description:
      "Employees scan customer QR orders, confirm payment, and log every transaction in real time.",
  },
];
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10">
        ...
        <div className=" space-y-3 max-w-[90%]">
          ...
          <p className="b1 text-text-secondary leading-relaxed">
            Turn every customer's smartphone into an ordering terminal. No
            tablets, no stands — just scan, browse, and trigger the kitchen.
          </p>
        </div>
        ...
        {/* AI Banner */}
        <div
          className="relative rounded-3xl p-10 md:p-[52px_56px] flex flex-col md:flex-row items-center justify-between gap-10 overflow-hidden"
          style={{
            background:
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, color-mix(in srgb, var(--color-brand-primary) 10%, transparent) 0%, transparent 65%)",
            }}
          />
          ...
          <div className="flex-1 relative z-10 space-y-4 max-w-[620px]">
            ...
            <p className="b2 text-text-secondary max-w-[600px]">
              Your AI concierge understands plain language. It recommends,
              upsells, modifies, and adds items to the live cart — all through a
