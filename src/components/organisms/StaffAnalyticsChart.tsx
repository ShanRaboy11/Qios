        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
            ...
            <YAxis 
              ...
              tickLine={false} 
              tick={{ fontSize: 11, fill: '#9CA3AF' }}
              label={{ value: 'Prep Time (mins)', angle: -90, position: 'insideLeft', style: { fill: '#9CA3AF', fontSize: 11 } }}
            />
            <YAxis 
              yAxisId="right" 
              orientation="right" 
              ...
              tickLine={false} 
              tick={{ fontSize: 11, fill: '#9CA3AF' }}
              label={{ value: 'Order Count', angle: 90, position: 'insideRight', style: { fill: '#9CA3AF', fontSize: 11 } }}
            />
            <Tooltip 
            ...
            <ReferenceArea yAxisId="left" x1="11:30" x2="13:00" fill="#FEF3C7" fillOpacity={0.3} strokeDasharray="3 3" stroke="#FBBF24" />
