...
import { Plus, Search, Shield, ShieldAlert, Check, Copy, Trash2, GripVertical, ShoppingCart, Package, LineChart, QrCode, Users, X } from "lucide-react";
            ...
            {filteredRoles.map((role) => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className={cn("w-3 h-3 rounded-full shadow-sm shrink-0", role.color)} />
