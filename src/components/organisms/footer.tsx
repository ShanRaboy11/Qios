  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(0deg, var(--brand-secondary, #FFD77A) -11.44%, #FFF 100%)",
        }}
      />
      ...
      >
        <div className="flex flex-col items-center md:items-end gap-8 mt-4 shrink-0">
          {!shouldHideSocials && (
                ...
                >
                  ...
                  >
                    <path
                      ...
                      className="stroke-brand-accent group-hover:stroke-brand-primary transition-colors duration-300"
                    />
                  </svg>
                </a>
                <a
