...
export default function IngredientsInventory() {
  ...
  const [activeTab, setActiveTab] = useState<"measurement" | "unit">("measurement");
    ...
    <div className="w-full flex flex-col gap-6 font-inter">
      ...
      {filteredItems.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 bg-white/50 border border-black/5 rounded-3xl min-h-[300px]">
          ...
          <h3 className="h4 text-text-primary font-semibold">No ingredients found</h3>
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-2 bg-black/[0.02] rounded-xl p-3">
                  <div className="flex flex-col gap-1">
                    <span className="text-[10px] uppercase font-bold text-text-secondary tracking-wide">Stock</span>
                    <span className="b2 font-bold text-text-primary">{item.current_stock}</span>
                  </div>
                  <div className="flex flex-col gap-1 border-l border-black/5 pl-2">
                    <span className="text-[10px] uppercase font-bold text-text-secondary tracking-wide">Low</span>
                    <span className="b2 font-bold text-text-primary">{item.low_stock_threshold}</span>
                  </div>
                  <div className="flex flex-col gap-1 border-l border-black/5 pl-2">
                    <span className="text-[10px] uppercase font-bold text-text-secondary tracking-wide">Crit</span>
                    <span className="b2 font-bold text-text-primary">{item.critical_stock_threshold}</span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setDraftItem({ ...draftItem, low_stock_threshold: parseFloat(e.target.value) || 0 })}
                  />
                </div>
                <div>
                  <label className="block b5 font-bold text-text-secondary uppercase tracking-widest mb-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDraftItem({ ...draftItem, critical_stock_threshold: parseFloat(e.target.value) || 0 })}
                  />
                </div>
              </div>
            </div>
