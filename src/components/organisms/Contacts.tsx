  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      >
        ...
        />
        {error && (
          <AlertCircle size={16} className="shrink-0 text-warning-primary" />
        )}
      </div>
      {error && (
          ...
          >
            <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-md p-10 flex flex-col items-center text-center gap-6 animate-in zoom-in-95 fade-in duration-200">
              ...
              <div className="relative w-16 h-16">
                ...
                />
                <div className="relative w-16 h-16 rounded-full bg-success-secondary flex items-center justify-center shadow-lg shadow-success-primary/20">
                  <svg
                    viewBox="0 0 24 20"
                    fill="none"
                    stroke="currentColor"
                    ...
                    className="w-7 h-7 text-success-primary"
                  >
