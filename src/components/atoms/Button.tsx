...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      outline:
        "border-brand-primary border-2 text-brand-primary hover:bg-brand-primary hover:border-brand-primary hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg cursor-pointer active:scale-[0.98]",
